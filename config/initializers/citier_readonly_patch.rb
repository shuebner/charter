# replace #save and #save! of citier children (child_instance_methods.rb)
# so that readonly is no longer ignored
Citier::ChildInstanceMethods.module_eval do
  def save(options={})
  ...
  def save!(options={})
    raise ActiveRecord::ReadOnlyRecord.new(self) if (self.readonly?)
